...
//=========  (Tue Dec  6 13:01:26 2016) by ROOT version6.06/01
   ...
   Double_t x_1000_expBand_graph_fx1[37] = {
   1,
   2,
   3,
   5,
   ...
   1,
   1};
   Double_t x_1000_expBand_graph_fy1[37] = {
   420.566,
   72.04,
   34.28389,
   17.03311,
   ...
   135.2788,
   420.566};
   TGraph *graph = new TGraph(37,x_1000_expBand_graph_fx1,x_1000_expBand_graph_fy1);
   ...
   Graph_x_300_expBand_graph2->SetMinimum(4.190157);
   Graph_x_300_expBand_graph2->SetMaximum(1132.582);
   ...
   Graph_x_300_exp_graph4->SetMinimum(7.059375);
   Graph_x_300_exp_graph4->SetMaximum(610.6781);
   ...
   Double_t x_1000_expDn_graph_fx5[18] = {
   1,
   2,
   3,
   5,
   ...
   1000,
   1000};
   Double_t x_1000_expDn_graph_fy5[18] = {
   135.2788,
   24.09893,
   11.67871,
   5.830676,
   ...
   5.06447,
   5.06447};
   graph = new TGraph(18,x_1000_expDn_graph_fx5,x_1000_expDn_graph_fy5);
   ...
   Graph_x_1000_expDn_graph5->SetMinimum(1.34158);
   Graph_x_1000_expDn_graph5->SetMaximum(148.6576);
   ...
   Graph_x_300_expUp_graph6->SetMinimum(12.06811);
   Graph_x_300_expUp_graph6->SetMaximum(1131.707);
   ...
   Graph_x_300_obs_graph7->SetMinimum(6.850329);
   Graph_x_300_obs_graph7->SetMaximum(589.6621);
   ...
   Double_t x_1000_obs_graph_fx8[18] = {
   1,
   2,
   3,
   5,
   ...
   1000,
   1000};
   Double_t x_1000_obs_graph_fy8[18] = {
   223.5312,
   39.25903,
   19.11226,
   9.536674,
   ...
   8.235864,
   8.235864};
   graph = new TGraph(18,x_1000_obs_graph_fx8,x_1000_obs_graph_fy8);
   ...
   Graph_x_1000_obs_graph8->SetMinimum(2.266736);
   Graph_x_1000_obs_graph8->SetMaximum(245.6325);
   ...
   Double_t x_1000_exp_graph_fx9[18] = {
   1,
   2,
   3,
   5,
   ...
   1000,
   1000};
   Double_t x_1000_exp_graph_fy9[18] = {
   230.9375,
   40.625,
   19.6875,
   9.78125,
   ...
   8.46875,
   8.46875};
   graph = new TGraph(18,x_1000_exp_graph_fx9,x_1000_exp_graph_fy9);
   ...
   Graph_x_1000_exp_graph9->SetMinimum(2.327344);
   Graph_x_1000_exp_graph9->SetMaximum(253.7727);
   ...
   Graph_x_300_expDn_graph10->SetMinimum(4.190157);
   Graph_x_300_expDn_graph10->SetMaximum(357.3187);

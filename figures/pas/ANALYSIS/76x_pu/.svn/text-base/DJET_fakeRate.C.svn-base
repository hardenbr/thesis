...
// By ROOT version 6.06/00 on 2016-12-06 12:30:14
...
void DJET_fakeRate()
{
   ...
   // menu bar
   TGMenuBar *fMenuBar12 = new TGMenuBar(fRootCanvas2,800,21,kHorizontalFrame);

   // "File" menu
   TGPopupMenu *fPopupMenu4 = new TGPopupMenu(gClient->GetDefaultRoot(),114,137,kOwnBackground);
   ...
   // cascaded menu "Save"
   TGPopupMenu *fPopupMenu3 = new TGPopupMenu(gClient->GetDefaultRoot(),63,159,kOwnBackground);
   fPopupMenu3->AddEntry("t.&ps",5);
   fPopupMenu3->AddEntry("t.&eps",6);
   fPopupMenu3->AddEntry("t.p&df",7);
   fPopupMenu3->AddEntry("t.&tex",11);
   fPopupMenu3->AddEntry("t.&gif",8);
   fPopupMenu3->AddEntry("t.&jpg",9);
   fPopupMenu3->AddEntry("t.&png",10);
   fPopupMenu3->AddEntry("t.&C",4);
   fPopupMenu3->AddEntry("t.&root",3);
   ...
   // "Edit" menu
   TGPopupMenu *fPopupMenu6 = new TGPopupMenu(gClient->GetDefaultRoot(),73,137,kOwnBackground);
   ...
   // cascaded menu "Clear"
   TGPopupMenu *fPopupMenu5 = new TGPopupMenu(gClient->GetDefaultRoot(),75,40,kOwnBackground);
   ...
   // "View" menu
   TGPopupMenu *fPopupMenu8 = new TGPopupMenu(gClient->GetDefaultRoot(),128,171,kOwnBackground);
   ...
   TGPopupMenu *fPopupMenu7 = new TGPopupMenu(gClient->GetDefaultRoot(),81,40,kOwnBackground);
   ...
   // "Options" menu
   TGPopupMenu *fPopupMenu9 = new TGPopupMenu(gClient->GetDefaultRoot(),157,205,kOwnBackground);
   ...
   // "Tools" menu
   TGPopupMenu *fPopupMenu10 = new TGPopupMenu(gClient->GetDefaultRoot(),125,108,kOwnBackground);
   ...
   // "Help" menu
   TGPopupMenu *fPopupMenu11 = new TGPopupMenu(gClient->GetDefaultRoot(),130,150,kOwnBackground);
   ...
   TGHorizontal3DLine *fHorizontal3DLine20 = new TGHorizontal3DLine(fRootCanvas2,800,2);
   ...
   fDockableFrame21->SetWindowName("ToolBar: ");
   fDockableFrame21->DockContainer();

   fRootCanvas2->AddFrame(fDockableFrame21, new TGLayoutHints(kLHintsExpandX));
   TGHorizontal3DLine *fHorizontal3DLine26 = new TGHorizontal3DLine(fRootCanvas2,800,2);
   fRootCanvas2->AddFrame(fHorizontal3DLine26, new TGLayoutHints(kLHintsTop | kLHintsExpandX));

   // composite frame
   TGCompositeFrame *fCompositeFrame27 = new TGCompositeFrame(fRootCanvas2,800,577,kHorizontalFrame);

   // composite frame
   TGCompositeFrame *fCompositeFrame28 = new TGCompositeFrame(fCompositeFrame27,175,577,kFixedWidth);
   ...
   // canvas widget
   TGCanvas *fCanvas29 = new TGCanvas(fCompositeFrame27,800,577,kSunkenFrame);
   ...
   // status bar
   TGStatusBar *fStatusBar42 = new TGStatusBar(fRootCanvas2,10,19);
   ...
   fRootCanvas2->Move(0,0);
   fRootCanvas2->Resize(800,600);
}  

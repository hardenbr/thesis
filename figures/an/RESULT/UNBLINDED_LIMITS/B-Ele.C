...
//=========  (Thu Nov 10 15:58:11 2016) by ROOT version6.06/01
   ...
   Graph_x_300_exp_graph3->SetMinimum(4.598438);
   Graph_x_300_exp_graph3->SetMaximum(438.9391);
   ...
   Graph_x_1000_expDn_graph4->SetMinimum(1.178195);
   Graph_x_1000_expDn_graph4->SetMaximum(115.8397);
   ...
   Graph_x_300_expUp_graph5->SetMinimum(8.007737);
   Graph_x_300_expUp_graph5->SetMaximum(862.4636);
   ...
   Graph_x_300_obs_graph6->SetMinimum(4.473271);
   Graph_x_300_obs_graph6->SetMaximum(423.8783);
   ...
   Graph_x_1000_obs_graph7->SetMinimum(2.035104);
   Graph_x_1000_obs_graph7->SetMaximum(186.7849);
   ...
   Graph_x_1000_exp_graph8->SetMinimum(2.088281);
   Graph_x_1000_exp_graph8->SetMaximum(192.543);
   ...
   Graph_x_300_expDn_graph9->SetMinimum(2.679943);
   Graph_x_300_expDn_graph9->SetMaximum(244.6515);
...
tex->SetNDC();
   ...
   line->SetLineWidth(2);
   line->Draw();
      tex = new TLatex(0.175,0.235,"B-Ele");
tex->SetNDC();
   tex->SetTextFont(42);

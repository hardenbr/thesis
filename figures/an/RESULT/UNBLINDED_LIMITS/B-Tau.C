...
//=========  (Thu Nov 10 16:04:11 2016) by ROOT version6.06/01
   ...
   Graph_x_300_exp_graph3->SetMinimum(5.9625);
   Graph_x_300_exp_graph3->SetMaximum(386.4);
   ...
   Graph_x_1000_expDn_graph4->SetMinimum(1.176716);
   Graph_x_1000_expDn_graph4->SetMaximum(111.1582);
   ...
   Graph_x_300_expUp_graph5->SetMinimum(10.28805);
   Graph_x_300_expUp_graph5->SetMaximum(697.5746);
   ...
   Graph_x_300_obs_graph6->SetMinimum(5.797638);
   Graph_x_300_obs_graph6->SetMaximum(373.276);
   ...
   Graph_x_1000_obs_graph7->SetMinimum(1.997717);
   Graph_x_1000_obs_graph7->SetMaximum(184.0369);
   ...
   Graph_x_1000_exp_graph8->SetMinimum(2.046094);
   Graph_x_1000_exp_graph8->SetMaximum(190.7602);
   ...
   Graph_x_300_expDn_graph9->SetMinimum(3.527702);
   Graph_x_300_expDn_graph9->SetMaximum(229.6243);
...
tex->SetNDC();
   ...
   line->SetLineWidth(2);
   line->Draw();
      tex = new TLatex(0.175,0.235,"B-Tau");
tex->SetNDC();
   tex->SetTextFont(42);

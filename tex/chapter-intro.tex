...
in 2012~\ref{higgsdiscoveryAtlas,Chatrchyan:2012ufa}, the properties of the Higgs have been narrowed
...
Figure~\ref{measuredmass} provides experimental evidence for the precision measurement of this
...
of the Higgs tri-linear coupling, which provides further understanding of the Higgs potential.
...
is 9.96 fb level (including NLO corrections). This is unfortunately out of reach of current
...
This possiblilty is discussed briefly in Subsection~\ref{subsec:nonres_th}.

\begin{figure}
\begin{center}
\includegraphics[width=.32\textwidth]{figures/diagrams/diHiggs_lambda.pdf}
\includegraphics[width=.32\textwidth]{figures/diagrams/diHiggs_yt.pdf}
\includegraphics[width=.32\textwidth]{figures/diagrams/diHiggs_c2.pdf}
\end{center}
\caption{
...
\subsection{Resonant Double Higgs Production from BSM\label{subsec:nonres_th}
...
In this analysis, the production of a pair of Higgses with the CMS detector. We base
ourselves on the discovery of a Higgs-like object with mass around 125 GeV by both CMS and
ATLAS.We focus on resonant double Higgs (125 GeV) final states and we neglect the Standard
Model double Higgs contributions.
A clear and fully reconstructible channel to probe the double SM Higgs production is the one
where one of the Higgses decays into two photons, and the other one into b-quarks. Assuming
the same branching ratio as in the Standard Model, this channel represents 0.26% of the total
decay branching ratio of the HH system, as shown in the table 1. The fact that we are looking
for the case when one of the Higgses decays into two photons does not allow us to exploit fully
boosted scenarios. However, adding substructure studies for the hadronic Higgs would allow
us to extend the range of the resonant search to higher masses [10].

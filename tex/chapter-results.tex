...
constrained to be the same. The position of the peak follows the closely the respective $m_X$ hypothesis,
...
shown in Figure~\ref{} for both categories and both mass regimes. The break at 400 GeV corresponds
...
$\text{BR}(R\rightarrow HH) =$~25\% for all Radion masses above 300 GeV.

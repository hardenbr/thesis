...
\input{tables/table-cutflow_anal}
...
%\includegraphics[width=.38\textwidth]{figures/pas/SELECTION/76x/HT575/alpha_ht575_76x.pdf}\\
...
The variable $\alpha_{\textrm{max}}$ characterizes the disassociation of the jet's tracks and all fitted primary vertices 
in an event.
...
%% \begin{equation}
%% \alpha_{\textrm{jet}}(\textrm{PV}) = \frac{\sum_{\textrm{tracks} \in \textrm{PV}} p_{\textrm{t}}^{\textrm{tracks}}}{\sum_{\textrm{tracks}} p_{\textrm{t}}^{\textrm{tracks}}}~,
%% \end{equation}
...
%\includegraphics[width=.38\textwidth]{FIGS/SELECTION/76x/HT575/theta_ht575_76x.pdf}
...
%\includegraphics[width=.38\textwidth]{FIGS/SELECTION/76x/HT575/ipsig_ht575_76x_linear.pdf}
...
The requirements included in the baseline tag definition are determined through a scan of the relavant parameter space. The values
...
The training set is chosen as the set of all Jet-Jet samples $m_{X^0}=50\ldots 1500$ GeV with $c\tau_0=1,3$~mm. 
...
\begin{figure}
\begin{center}
\includegraphics[width=.6\textwidth]{pics/nuclear_interactions}\\
\includegraphics[width=.6\textwidth]{pics/signal_vertices}
...
The probability is determined for each event for $N_{\textrm{tags}} \leq N_{\textrm{jets}}$. The predicted number of events with
...
\input{signal_removal}
\input{cross_validation}
\input{signal_injection}
...
\begin{figure}
\begin{center}
\includegraphics[width=.85\textwidth]{pics/signal_r_zoom}
...
\begin{figure}
\begin{center}
\includegraphics[width=.70\textwidth]{pics/signal_r}
\includegraphics[width=.85\textwidth]{pics/signal_z}

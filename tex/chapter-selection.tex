...
In the case of choosing the jets for the dijet candidate, four choices were considered after b-tagging:
\begin{itemize}
...
deposits. As the photon shower have a much more narrow width, one ECAL cell contains more energy
than the maximum HCAL unit corresponding to a jet, whose showers tend to be more uniform inside
the jet cone. The transverse plane is shown which highlights the secondary vertex corresponding to

...
\begin{subequations}
\begin{equation}
\beta^* = \frac{\sum_{i\in \text{other PV}} p_{{\rm T},i}}{\sum_{i \text{charged}} p_{{\rm T},i}}
\end{equation}
\begin{equation}
...
\subsection{B-tagging and Event Classification\label{subsec:btag}}
...
\end{center}
\caption{
Resolution improvements for the \Mjj\, spectrum at $m_X = 270, 300, 350, 400$~GeV mass points.
...
\end{center}
\caption{
Improvement in the $p_{\rm T}$ balance before (left) and after (right) the regression is

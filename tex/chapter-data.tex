...
Event generation begins with sampling a probability distribution
...
an exact calculation of the probability distribution computationally infeasible.
...
interactions (MPI) from other partons interactions in the proton-proton collision with their
associated ISR and FSR, and beam remnants from the outgoing protons. 
continue hrrr!!!

everything connected by color confinement

fragmentation to produce primary hadrons
hadrons decay further
\cite{Dobbs:2004qw}

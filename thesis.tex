...
\title{An Inclusive Search for New Long-lived Particles at the Large Hadron Collider in $\sqrt{s}=13$ TeV Data}

\submitted{June 2017}  % degree conferral date (January, April, June, September, or November)
...
\dedication{To Arda, \\
my brother,\\
may no distance ever alter our friendship.
}
...
\include{tex/chapter-intro}
\include{tex/chapter-theory}
\include{tex/chapter-collider_theory}
\include{tex/chapter-cms}
\include{tex/chapter-djet_studies}
\include{tex/chapter-djet_analysis}
\include{tex/chapter-conclusions}

\appendix % all chapters following will be labeled as appendices
%\include{tex/appendix-mom}
%\include{tex/appendix-pastwork}

% Make the bibliography single spaced
\singlespacing
%\bibliographystyle{ieeetrnat}
